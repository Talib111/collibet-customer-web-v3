					...
					<div className="overflow-hidden bg-black lg:mx-8 lg:flex lg:max-w-6xl lg:w-full lg:shadow-md lg:rounded-xl">
						<div className="lg:w-1/2">
							<div
								...
								style={{
									backgroundImage:
										"url('https://res.cloudinary.com/dcxnmagjx/image/upload/v1688970755/kelly-sikkema--NY2yXT2EOE-unsplash_usgrst.jpg')",
								}}
							></div>
						</div>
					...
					<div className="">
						<div className="grid max-w-lg grid-cols-4 items-center gap-x-1 gap-y-1 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-4">
							<motion.img
								...
								src="https://res.cloudinary.com/dcxnmagjx/image/upload/v1688972872/Verified_Card_Logo_uephsu.png"
								alt="Transistor"
								width={250}
								height={250}
							/>
